...
<html lang="en">
<?php include ("php.php");
if (isset($_POST['insert_product.php']))
{
    ...
    $insertproquery = "insert into products (pro_cat,pro_brand,pro_title,pro_price,pro_desc) 
                        values ($pro_cat,$pro_brand,$pro_title,$pro_price,$pro_desc)";
...
<div class="container">
    ...
    <form action="insert_product.php" method="post">
        ...
        <div class="row my-3">
            ...
            <div class="col-sm-9 col-md-8 col-lg-4 col-xl-4">
                <button type="submit" name="ins_pro" class="btn btn-primary btn-block"><i class="fas fa-plus"></i> Insert Now </button>
            </div>
        </div>
    </form>
</div>
